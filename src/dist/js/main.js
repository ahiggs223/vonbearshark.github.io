...
},{"./router":230,"babelify/polyfill":3,"mithril":191}],195:[function(require,module,exports){
'use strict';
...
},{"./controller":196,"./view":197,"mithril":191}],196:[function(require,module,exports){
'use strict';
...
},{"../../models/user":229}],197:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "header", attrs: {}, children: [{ tag: "div", attrs: { id: "header-background-video" }, children: [{ tag: "video", attrs: { loop: "true", muted: "true", autoplay: "true" }, children: [ctrl.bannerVideos.map(function (video) {
                    return { tag: "source", attrs: { src: video.path, type: video.type } };
                })] }] }, { tag: "img", attrs: { id: "profilePicture",
                src: ctrl.profilePicture, alt: "Profile Picture" } }, { tag: "h1", attrs: {}, children: [ctrl.name] }, { tag: "h3", attrs: {}, children: [ctrl.tagline] }, { tag: "div", attrs: { id: "icons" }, children: [ctrl.contacts.map(function (contact) {
                return { tag: "a", attrs: { href: contact.link }, children: [{ tag: "img", attrs: { 'class': "icon",
                            src: contact.iconPath, alt: contact.name } }] };
            })] }] };
};

},{"mithril":191}],198:[function(require,module,exports){
'use strict';
...
},{"./controller":199,"./view":200,"mithril":191}],199:[function(require,module,exports){
'use strict';
...
},{"../../models/user":229}],200:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { id: "coverletter" }, children: [{ tag: "div", attrs: { 'class': "letter-outer" }, children: [{ tag: "div", attrs: { 'class': "letter-inner" }, children: [ctrl.coverLetterParagraphs.map(function (paragraph) {
                    return { tag: "p", attrs: {}, children: [paragraph] };
                }), { tag: "p", attrs: {}, children: ["Click here to", { tag: "a", attrs: { href: "content/resume/jjnaughtonresume.pdf",
                            target: "_blank" }, children: ["download a PDF version"] }, "of my resume."] }] }] }] };
};

},{"mithril":191}],201:[function(require,module,exports){
'use strict';
...
},{"./controller":202,"./view":203,"mithril":191}],202:[function(require,module,exports){
'use strict';
...
},{"../../models/user":229}],203:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "footer", attrs: {}, children: [{ tag: "p", attrs: {}, children: ["Homemade with Mitrhil.js."] }, { tag: "a", attrs: { href: 'mailto:' + ctrl.email }, children: ["Contact Via Email"] }] };
};
...
},{"./controller":205,"./view":206,"mithril":191}],205:[function(require,module,exports){
'use strict';
...
},{"mithril":191}],206:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "section", attrs: {}, children: [ctrl.test, BannerComponent, NavComponent, { tag: "div", attrs: { id: "main" }, children: [CoverLetterComponent, ResumeComponent] }, FooterComponent] };
};

},{"../Banner/Banner":195,"../CoverLetter/CoverLetter":198,"../Footer/Footer":201,"../Nav/Nav":207,"../Resume/Resume":222,"mithril":191}],207:[function(require,module,exports){
'use strict';
...
},{"./controller":208,"./view":209,"mithril":191}],208:[function(require,module,exports){
'use strict';

var model = require('../../models/nav');
...
},{"../../models/nav":228}],209:[function(require,module,exports){
/* @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "nav", attrs: {}, children: [{ tag: "ul", attrs: {}, children: [ctrl.routes.map(function (route) {
                return { tag: "li", attrs: {}, children: [{ tag: "a", attrs: { href: route.route, config: m.route }, children: [{ tag: "h2", attrs: {}, children: [route.name] }] }] };
            })] }] };
};

},{"mithril":191}],210:[function(require,module,exports){
'use strict';
...
},{"./controller":214,"./view":215,"mithril":191}],211:[function(require,module,exports){
'use strict';
...
},{"./controller":212,"./view":213,"mithril":191}],212:[function(require,module,exports){
'use strict';
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { 'class': "project-outer" }, children: [{ tag: "div", attrs: { 'class': "project-inner" }, children: [{ tag: "h2", attrs: {}, children: [{ tag: "a", attrs: { href: ctrl.project.site, target: "_blank" }, children: [ctrl.project.project] }] }, { tag: "p", attrs: {}, children: [ctrl.project.description] }, { tag: "p", attrs: {}, children: ["Check out the live", { tag: "a", attrs: { href: ctrl.project.site, target: "_blank" }, children: ["application"] }, "or the", { tag: "a", attrs: { href: ctrl.project.repo, target: "_blank" }, children: ["Github repository"] }, "!"] }] }] };
};

},{"mithril":191}],214:[function(require,module,exports){
'use strict';
...
},{"../../models/user":229}],215:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "section", attrs: {}, children: [BannerComponent, NavComponent, { tag: "div", attrs: { id: "main" }, children: [{ tag: "div", attrs: { id: "projects" }, children: [ctrl.projects.map(function (project) {
                    return m.component(ProjectComponent, { project: project });
                })] }] }, FooterComponent] };
};

},{"../Banner/Banner":195,"../Footer/Footer":201,"../Nav/Nav":207,"./Project/Project":211,"mithril":191}],216:[function(require,module,exports){
'use strict';
...
},{"./controller":217,"./view":218,"mithril":191}],217:[function(require,module,exports){
'use strict';
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { 'class': "organization" }, children: [ctrl.organization.name ? { tag: "h3", attrs: { 'class': "name" }, children: [ctrl.organization.name] } : null, ctrl.organization.positions.map(function (position) {
            return m.component(PositionComponent, { position: position });
        })] };
};

},{"../Position/Position":219,"mithril":191}],219:[function(require,module,exports){
'use strict';
...
},{"./controller":220,"./view":221,"mithril":191}],220:[function(require,module,exports){
'use strict';
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { 'class': "position" }, children: [ctrl.position.title ? { tag: "h4", attrs: { 'class': "title" }, children: [ctrl.position.title] } : null, ctrl.position.date ? { tag: "h4", attrs: { 'class': "date" }, children: [ctrl.position.date] } : null, ctrl.position.description ? { tag: "p", attrs: { 'class': "description" }, children: [ctrl.position.description] } : null] };
};

},{"mithril":191}],222:[function(require,module,exports){
'use strict';
...
},{"./controller":226,"./view":227,"mithril":191}],223:[function(require,module,exports){
'use strict';
...
},{"./controller":224,"./view":225,"mithril":191}],224:[function(require,module,exports){
'use strict';
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { 'class': "section" }, children: [ctrl.section.heading ? { tag: "h2", attrs: { 'class': "heading" }, children: [ctrl.section.heading] } : null, ctrl.section.organizations.map(function (organization) {
            return m.component(OrganizationComponent, { organization: organization });
        })] };
};

},{"../Organization/Organization":216,"mithril":191}],226:[function(require,module,exports){
'use strict';
...
},{"../../models/user":229}],227:[function(require,module,exports){
/** @jsx m */
...
module.exports = function (ctrl) {
    return { tag: "div", attrs: { id: "resume" }, children: [ctrl.resume.map(function (section) {
            return m.component(SectionComponent, { section: section });
        })] };
};

},{"./Section/Section":223,"mithril":191}],228:[function(require,module,exports){
"use strict";
...
var user = {
    ...
    coverLetterParagraphs: ["I am an undergraduate CS student at the University of Pittsburgh, expected to graduate May 2017.", "Over this summer of 2015, I interned with PayPal as a software engineer intern at the San Jose headquarters. As a part of the Next-Gen Commerce team, I was treated as a full-time employee and contributed to brainstorming and prototyping the latest (and, unfortunately, confidential) payments technology with senior leadership and partners in a lean, startup-like, agile environment. I've also been working with OThot, a Pittsburgh-based data-science and analytics startup, since this January, helping build the user interface for their analytics engine from the ground up. In addition to this professional experience, I have been very involved with the Pitt Computer Science Club. I have presented on various web development topics, and helped organize the university's first hackathon, Steelhacks.", "Technically, I have the most experience with isomorphic JavaScript stacks: Node/Express, Seneca, Meteor, and frontend frameworks and libraries, such as Angular, Backbone, and React, in addition to HTML/Handlebars, CSS/SCSS (and frameworks such as Pure and Bootstrap), and jQuery. Most of my formal CS education is in Java and Python, and I have used Django and Flask for hackathon projects. In storage, I am most familiar with NoSQL databases, especially MongoDB and Cassandra, but I have used MySQL for the aforementioned hackathon projects. For ops, I am generally familiar with git, Linux environments, Vagrant and virtual machines, and, lately, I have been dipping my toes into Docker and the related ecosystem.", "In addition to my technical skills, I also have a wealth of communications, public relations writing, and social media management experience gained from my completed B.A. in English Writing, certificate in Professional and Public Writing, and related internships.", "I am looking to work in the company of equally passionate creators, on projects that impact the world at large.", "I am an undergraduate CS student at the University of Pittsburgh, expected to graduate May 2017.", "Over this summer of 2015, I interned with PayPal as a software engineer intern at the San Jose headquarters. As a part of the Next-Gen Commerce team, I was treated as a full-time employee and contributed to brainstorming and prototyping the latest (and, unfortunately, confidential) payments technology with senior leadership and partners in a lean, startup-like, agile environment. I've also been working with OThot, a Pittsburgh-based data-science and analytics startup, since this January, helping build the user interface for their analytics engine from the ground up. In addition to this professional experience, I have been very involved with the Pitt Computer Science Club. I have presented on various web development topics, and helped organize the university's first hackathon, Steelhacks.", "Technically, I have the most experience with isomorphic JavaScript stacks: Node/Express, Seneca, Meteor, and frontend frameworks and libraries, such as Angular, Backbone, and React, in addition to HTML/Handlebars, CSS/SCSS (and frameworks such as Pure and Bootstrap), and jQuery. Most of my formal CS education is in Java and Python, and I have used Django and Flask for hackathon projects. In storage, I am most familiar with NoSQL databases, especially MongoDB and Cassandra, but I have used MySQL for the aforementioned hackathon projects. For ops, I am generally familiar with git, Linux environments, Vagrant and virtual machines, and, lately, I have been dipping my toes into Docker and the related ecosystem.", "In addition to my technical skills, I also have a wealth of communications, public relations writing, and social media management experience gained from my completed B.A. in English Writing, certificate in Professional and Public Writing, and related internships.", "I am looking to work in the company of equally passionate creators, on projects that impact the world at large."],
    resume: [{
...
},{"./components/Home/Home":204,"./components/Portfolio/Portfolio":210}]},{},[194]);
